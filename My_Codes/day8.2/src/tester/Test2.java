...
public class Test2 {
	 ...
	 * AL<String> , LL<Integer> , Vector<LocalDate> , HS<Double> , LHS,TS
		 */
//		ArrayList<String> strings=new ArrayList<>();                                // Array List
//		
//		strings.add("one");strings.add("two");strings.add("three");
//		
//		printElementsFromCollection(strings);                                      // by GenericUtils line by line op 
//		
////		System.out.println("  sopd "+strings);
...
//		printElementsFromCollection(dates);
	...
	//	HashSet<Double> hs=new HashSet<>(Arrays.asList(2,3,4,5,6,2,3,4));
		...
		HashSet<Integer> me = new HashSet<>(Arrays.asList(111,222,333,444));
		System.out.println("me set: "+ me);
		printElementsFromCollection(me);
		System.out.println("Using printElems ap1");
