...
//					.forEach(p -> System.out.println(p));
			...
			// by me =========================================================================
			System.out.println("removing category: " + cat);
//			ListIterator<Product> litr =  productList.listIterator();
//			while(litr.hasNext())
//			{
//				
//				if(litr.next().getProductCategory()==cat)
//					productList.remove(litr.hasNext());
//			}
