...
public class ShowroomManagementSystem {
	...
	public static void main(String[] args) {
		try (Scanner sc = new Scanner(System.in)) {
			...
			List<Vehicle> showroom = populateShowroom();// size=8, init capa=10          // Used List Interface:  
			...
			while (!exit) {
				...
				try {
					...
					case 5: //  Delete vehicle details  by ch no
						...
						index = showroom.indexOf(new Vehicle(sc.next()));                            // ref line 56 57// wrapping ch in vehicle 
						if (index == -1)
...
//								System.out.println("Removed " + showroom.remove(i));
					...
					case 7: // 7. Sort the vehicles as per ch no "
					...
					case 10: // custom ordering using ano innner class
						...
						// with the help of functional stream.
						System.out.println("Sorted list");
						showroom.stream()
						.sorted((s1,s2) -> s1.getManufactureDate().compareTo(s2.getManufactureDate()) )
