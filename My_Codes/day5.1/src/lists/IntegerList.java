...
public class IntegerList {
	...
	public static void main(String[] args) {
		...
		for (int i : data)// i=data[0].....
			intList.add(0,i);// append , auto boxing (int ---> Integer)// going to add elems in rev order
		
		
		System.out.println("populated AL " + intList);
		intList.add(99);
		System.out.println("AL again " + intList);// [10,2,34,11,5,4,-10,2,10,30,20,109,100,99]                                                  ]
